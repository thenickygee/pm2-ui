...
const Navbar = () => {
  ...
  return (
    <div className='px-3 w-full z-50 fixed top-0 bg-black/80 backdrop-blur-sm h-[55px] justify-between items-center align-middle flex select-none cursor-default'>
      {' '}
      <p className='font-bold text-gray-100 text-xl'>
        {' '}
        <FontAwesomeIcon icon={faHeartPulse} className='pr-2' /> PM2 UI
      </p>{' '}
